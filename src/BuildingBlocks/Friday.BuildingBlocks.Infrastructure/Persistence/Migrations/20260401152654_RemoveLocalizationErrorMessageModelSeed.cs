...
public partial class RemoveLocalizationErrorMessageModelSeed : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        // (Module, ErrorCode, Language). Use <c>Database:SeedOnStartup</c> or a release job to apply reference data.
    }

    /// <inheritdoc />
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        // No-op: do not reintroduce migration-owned seed; use IDataSeeder or SQL scripts instead.
    }
}
