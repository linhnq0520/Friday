...
[FridayDataMigration(
    ...
    "Data: admin.rights, admin.role_rights — permission catalog and role mappings (roles: see 20260418110000)."
)]
public sealed class Data_20260418120000_Admin_RolesRights : AutoReversingMigration
{
